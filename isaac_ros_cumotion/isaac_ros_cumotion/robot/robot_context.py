...
# isaac_ros_cumotion/robot/. This module only adds a rank BELOW strategy_lock.
#
...
#  2. buffer_lock is terminal: strategy modules under isaac_ros_cumotion/robot/ never
