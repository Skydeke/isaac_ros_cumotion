...
_STRATEGY_REGISTRY = {
    'emulator':    ('isaac_ros_cumotion.robot.emulator_strategy',    'EmulatorStrategy'),
    'joint_speed': ('isaac_ros_cumotion.robot.joint_speed_strategy', 'JointSpeedStrategy'),
    'joint_pose':  ('isaac_ros_cumotion.robot.joint_pose_strategy',  'JointPoseStrategy'),
}
