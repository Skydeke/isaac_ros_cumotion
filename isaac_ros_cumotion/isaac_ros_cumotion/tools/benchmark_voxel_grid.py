...
Usage (node must already be running):
    ros2 run isaac_ros_cumotion benchmark_voxel_grid
    ros2 run isaac_ros_cumotion benchmark_voxel_grid --ros-args -p voxel_size:=0.02
    ros2 run isaac_ros_cumotion benchmark_voxel_grid --ros-args -p voxel_size:=0.02 -p n_runs:=10
"""
