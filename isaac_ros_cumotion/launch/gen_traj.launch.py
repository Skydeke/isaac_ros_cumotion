...
def generate_launch_description():
    ...
    declare_urdf_path = DeclareLaunchArgument(
        'urdf_path',
        default_value='',
        description='Path to the robot URDF file (if empty, loaded from robot_config_file)'
    )
    ...
    declare_world_file = DeclareLaunchArgument(
        'world_file',
        default_value='',
        description='Path to the world configuration file (world config YAML)'
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            description="Extent (m) of the Mapper voxel grid, as a Python repr of a list [x, y, z]"
        ),
        DeclareLaunchArgument(
