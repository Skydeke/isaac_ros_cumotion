...
from isaac_ros_cumotion_interfaces.srv import WarmupIK
from isaac_ros_cumotion_interfaces.srv import WarmupFK
from isaac_ros_cumotion_interfaces.srv import Ik
from isaac_ros_cumotion_interfaces.srv import Fk
...
class GeneratedTestSuite(unittest.TestCase):
    ...
    def test_03_ik_valid_pose(self):
        ...
        # Create request
        request = Ik.Request()
        set_message_fields(request, {'pose': {'position': {'x': 0.0255, 'y': 0.1521, 'z': 0.8555}, 'orientation': {'x': -0.8049, 'y': -0.3629, 'z': -0.4516, 'w': 0.1288}}})
    ...
    def test_05_fk_valid_joints(self):
        ...
        # Create request
        request = Fk.Request()
        set_message_fields(request, {'joint_states': [{'position': [0.0, -1.3, 0.0, -2.5, 0.0, 1.5, 0.8]}]})
