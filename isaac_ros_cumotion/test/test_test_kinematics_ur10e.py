...
class GeneratedTestSuite(unittest.TestCase):
    ...
    def test_03_ik_valid_pose(self):
        ...
        # Create request
        request = Ik.Request()
        set_message_fields(request, {'pose': {'position': {'x': 0.3256, 'y': 0.4438, 'z': 0.756}, 'orientation': {'x': 0.7996, 'y': -0.5934, 'z': -0.0614, 'w': 0.0689}}})
    ...
    def test_05_fk_valid_joints(self):
        ...
        # Create request
        request = Fk.Request()
        set_message_fields(request, {'joint_states': [{'position': [0.0, -2.2, 1.9, -1.383, -1.57, 0.0]}]})
