...
namespace add_objects_display
{
    ...
    protected:
        ...
        void onAddUpdate(const isaac_ros_cumotion_interfaces::msg::ObjectParameters & request);
        void onRemoveUpdate(const std_msgs::msg::String & request);
        rviz_rendering::Shape::Type getShapeType(const int& type);
    
    private:
        rclcpp::Node::SharedPtr node_;
        rclcpp::Subscription<isaac_ros_cumotion_interfaces::msg::ObjectParameters>::SharedPtr add_object_subscriber_;
