...
#include <isaac_ros_cumotion_rviz/add_objects_display.hpp>
...
namespace add_objects_display
{
    ...
    void AddObjectsDisplay::onInitialize()
    {
        ...
        add_object_subscriber_ = node_->create_subscription<isaac_ros_cumotion_interfaces::msg::ObjectParameters>("add_objects_topic", 10, std::bind(&AddObjectsDisplay::onAddUpdate, this, std::placeholders::_1));
    ...
    void AddObjectsDisplay::onAddUpdate(const isaac_ros_cumotion_interfaces::msg::ObjectParameters & request)
    {
        try{
    ...
    rviz_rendering::Shape::Type AddObjectsDisplay::getShapeType(const int& type) {
        ...
        if (type == isaac_ros_cumotion_interfaces::srv::AddObject_Request::CUBOID) return rviz_rendering::Shape::Type::Cube;
        if (type == isaac_ros_cumotion_interfaces::srv::AddObject_Request::SPHERE) return rviz_rendering::Shape::Type::Sphere;
        if (type == isaac_ros_cumotion_interfaces::srv::AddObject_Request::CYLINDER) return rviz_rendering::Shape::Type::Cylinder;
        if (type == isaac_ros_cumotion_interfaces::srv::AddObject_Request::MESH) return rviz_rendering::Shape::Type::Mesh;
